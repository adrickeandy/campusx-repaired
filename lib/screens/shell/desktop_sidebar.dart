...
class _DesktopSidebarState extends State<DesktopSidebar> {
  ...
  // Pinned open by the user (click the logo/toggle) — overrides hover.
  bool _pinned = false;
    ...
    return MouseRegion(
      ...
      child: AnimatedContainer(
        ...
        child: Column(
          ...
          children: [
            // CampusX logo — tap to pin/unpin the sidebar open; long-standing
            // admin easter egg click handler is preserved via onLongPress.
            GestureDetector(
              onTap: () => setState(() => _pinned = !_pinned),
              onLongPress: () => ui.handleLogoClick(auth.isAdmin, context),
              child: MouseRegion(
            ...
            Expanded(
              child: ListView.separated(
                ...
                itemBuilder: (context, i) {
                  ...
                  // When collapsed, wrap with a tooltip so the label is still
                  // discoverable without needing to hover-expand the rail.
